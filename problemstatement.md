...
| **Struggle** | Repeated attempts, manual inspection, leaving the product | Recovery behaviours in 371 of 800; candidate inspection or uncertain candidate sets in 265. Across the corpus: strategy switching 166, browsing 158, reformulation 82, other app/device 90 | Medium |
| **Consequence** | Effort, uncertainty, giving up | Failed 43, gave up and asked someone 44, other app/device 46, similar-but-not-exact 41, found only after several attempts 36 | Low–Medium (only 210 of 800 records state any outcome) |
| **Cause** | *[open]* | Not established | None |

## 4. Target segment the statement points at

**TARGET SEGMENT HYPOTHESIS — TO BE VALIDATED.** Effortful-path retrievers: users who attempted to retrieve a specific photo they expected to exist, lacked a precise identifier, and either changed strategy or made several attempts (238 records), or manually inspected a candidate set (265 records). Together this is 503 of 800 records (62.9%).
